...
2. From here you can simply do source ./python/activate.sh and you should have the right venv
...
4. You should now be able to send commands wirelessly to your CRT!
    - For example scripts check out python/client_scripts
